...
main (int argc, char *argv[])
{
  ...
  // Dodavanje AH sloja svakom čvoru
 // for (uint32_t i = 0; i < nodes.GetN (); ++i)
  //{
   // Ptr<AhLayer> ahLayer = CreateObject<AhLayer> ();
    //nodes.Get (i)->AggregateObject (ahLayer);
 // }
 ...
 MobilityHelper mobility;
  ...
  NetDeviceContainer d2d1 = p2p1.Install (n2n1);
  ...
  SetStaticRoute(nodes.Get(2), "10.1.2.1", "10.1.1.2", 1);
